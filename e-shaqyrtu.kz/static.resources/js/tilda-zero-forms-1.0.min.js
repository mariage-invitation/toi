...
function t_zeroForms__createForm(t, e, r, o) {
    ...
    var l, _, i = document.createElement("div"),
        ...
        d = (s.insertAdjacentElement("beforeend", i), o.getAttribute("data-elem-id")),
        ...
        i = (r && ((i = document.createElement("div")).style.textAlign = "center" === n.buttonalign ? "center" : "left", i.style.color = a.color, i.style.fontWeight = a.fontWeight, i.style.fontFamily = a.fontFamily, i.style.marginTop = "15px", i.style.fontSize = "13px", a = t_zeroForms__getBottomText(d, n, t, o, r), i.appendChild(a), s.insertAdjacentElement("beforeend", i)), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(n, "bottom")), s.insertAdjacentElement("beforeend", t_zeroForms__createCommentField()), t_zeroForms__createInputPlaceholderStyles(d, n, t, o), "h" !== n.inputpos && "zero" !== e || (t_zeroForms__setScriptOrStyle(r = "t-zero-form-h-styles", "tilda-zero-form-horizontal.min.css", "", "link", !1), (a = document.getElementById(r)) && a.addEventListener("load", function() {
            ...
            t_zeroForms__animateInputs(o, n, t, d)
        }), "t-zero-form-font-family-" + t + "-" + d),
        i = (n.fieldfontfamily ? (l = t_zeroForms__createSelector(t, d, ""), t_zeroForms__setScriptOrStyle(i, "", (_ = (_ = ['input[type="text"]', 'input[type="tel"]', ".t-input-phonemask__select", "textarea", "select", ".t-input__vis-ph"]).reduce(function(t, e, r) {
        ...
        c = t_zeroForms__getTildaMode(),
        u = 0;
    return window.addEventListener(i, function() {
        u = u || setTimeout(function() {
            t_zeroForms__updateCurrentResolution(t, c), t_zeroForms__updateStylesOnResize(t, o), clearTimeout(u), u = 0
        }, 600)
    }), s
}
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    var i = t_zeroForms__generateButtonStyles(o, window.getComputedStyle(t).fontFamily),
        ...
        s = document.getElementById("t-uploadcare-zero-form"),
        l = document.getElementById("t-upwidget-zero-form"),
        _ = t_zeroForms__createSelector(e, r, ""),
        d = _ + ".t-submit",
        o = t_zeroForms__getGradientBGStyles(o, d),
