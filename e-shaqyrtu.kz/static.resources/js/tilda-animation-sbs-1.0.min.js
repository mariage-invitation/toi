...
function t_animationSBS__scrollAnimationCheckSteps(l, _, c) {
    ...
    }), _.classList.remove("t396__elem--anim-hidden"), _.steps[1] && 0 === _.steps[1].dist && 0 === _.steps[1].styles.opacity && "unactive" === _.steps[1].state && (c.opacity = 0)
}
...
function t_animationSBS__generateKeyframes__getFrameChanges(t, e) {
    ...
    var o, t = t_animationSBS__getScaleWrapper(t.querySelector(".tn-molecule, .tn-atom"));
    for (o in 1 === r || t || (r = 1), e.styles) switch (o) {
        case "opacity":
